      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:flex flex-col gap-8 px-8">
          ...
          <h2 className="text-4xl font-light leading-tight text-white">
            Autonomous Property <br />
            <span className="font-semibold">Risk Assessment</span> Platform
          </h2>
          <p className="text-white/60 leading-relaxed">
            Log in to access real-time title deed audits, environmental hazard analysis, and GIS parcel verification.
          </p>
          <div className="grid gap-4">
            {[
              { icon: '✓', value: '99.8%', label: 'Risk Audit Accuracy', color: 'text-[#4f9cf9]' },
              { icon: '⚡', value: 'Instant', label: 'Automated Public Registry Checks', color: 'text-[#00E5FF]' },
              { icon: '🛡', value: '50-State', label: 'Legal Compliance Auditing', color: 'text-[#E040FB]' },
            ].map((m) => (
        ...
        <div className="bg-[rgba(11,19,43,0.65)] backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full bg-white/[0.03] border border-white/10 rounded-lg px-4 py-3 text-white placeholder-white/30 text-sm outline-none focus:border-[#4f9cf9] focus:ring-2 focus:ring-[#4f9cf9]/20 transition-all"
              />
            </div>
            <div className="flex flex-col gap-1.5">
          ...
          <p className="mt-6 text-center text-sm text-white/40">
            ...
            <Link href="/register" className="text-[#4f9cf9] hover:underline">Register Enterprise Account</Link>
          </p>
        </div>
      </div>
    </main>
