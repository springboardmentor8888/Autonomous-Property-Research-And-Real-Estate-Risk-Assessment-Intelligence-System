          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-gray-500">
                Identify and evaluate potential risks associated with a
                property.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-400 mt-1">
                REDDA AI evaluates property data, documents, legal
                information and location factors to identify potential risks.
              </p>
            ...
            <div className="space-y-3">
              <div className="flex gap-3 bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p className="text-sm text-green-800">
                  Ownership information appears consistent with the
                  available data.
                </p>
              </div>
              ...
              <div className="flex gap-3 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p className="text-sm text-yellow-800">
                  Additional document verification is recommended before
                  final approval.
                </p>
              </div>
          ...
          <div className="flex gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-orange-700 mt-1">
                ...
                professional advice before making financial or legal
                decisions.
              </p>
            </div>
          </div>
